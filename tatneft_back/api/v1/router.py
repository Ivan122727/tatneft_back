...
from tatneft_back.api.v1.routers import action, auth, detected_human, event, reg, user
...
api_v1_router.include_router(router=action.router, prefix="/action", tags=["Action"])